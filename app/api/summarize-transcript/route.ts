import { MBTI_SUMMARY_SYSTEM_PROMPT, buildMbtiSummaryPrompt } from "@/lib/prompts";
...
export async function POST(request: Request) {
  ...
  try {
    const readable = await streamChat([
      { role: "system", content: MBTI_SUMMARY_SYSTEM_PROMPT },
      { role: "user", content: buildMbtiSummaryPrompt(body.mbtiType, body.dimensions) },
    ]);
